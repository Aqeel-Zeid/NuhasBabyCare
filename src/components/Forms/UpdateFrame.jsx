...
function UpdateFrame(props) {
    ...
    return (
        <Container>
                ...
                onSubmit={
                    fields => {
                        ...
                        const UPDATE_FRAME = gql`
                            mutation UpdatePhotoFrameTemplate
                            (
                                $FrameName : String
                        ...
                        (
                            (err) => 
                            {
                                alert("Updating Failed Successfully")
                                console.log(err)
                            }
                        )
            ...
            />
            <S3ImageUploader imageName = {props.FrameID}/>
        </Container>
    )
}
